let playlist = [ {
  'title': 'Kënga shembull 1',
  'audio': "assets/sample.weba",
}, {
  'title': 'Kënga shembull 2',
  'audio': "assets/sample2.weba",
} ];
i = 0;
n = playlist.length;
...
/* dëgjues të bashkangjitur pasi të jenë përcaktuar funksionet (shmang garën me ngarkimin e metadatave) */
player.addEventListener("loadedmetadata",function(){mDur();initProgressBar();});
player.addEventListener("timeupdate",initProgressBar);
if(player.readyState>=1){try{mDur();initProgressBar();}catch(e){}}
